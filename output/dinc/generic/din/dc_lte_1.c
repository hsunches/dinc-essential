...
#pragma pack()
la_int l849_start_lte_ipc_routine(lb_void);
...
lb_void*l41_arg);lb_void _mb000010000(lb_void);l19_extern la_int
_mb000000002;l19_extern lb_void l452_handle_options(la_int l31_argc,
lj_char*l18_argv[]);lb_void l1112_dc_lte_version(lb_void)l189___attribute
((l202_used));lb_void l997_dc_lte_init(lb_void)l189___attribute((
l202_used));lb_void l1100_dc_lte_load_config(li_const lj_char*
l230_path)l189___attribute((l202_used));lm_uint32_t l1095_dc_lte_id(
lb_void)l189___attribute((l202_used));la_int l1078_dc_lte_main(la_int
l31_argc,lj_char*l18_argv[])l189___attribute((l202_used));la_int
l1078_dc_lte_main(la_int l31_argc,lj_char*l18_argv[]){
l323_lte_data_set l282_ds={};l86_memset(&l282_ds,0,lw_sizeof(l282_ds));
lh_gp_lte_data_set=&l282_ds;l312_lte_cfg l375_cfg={};l71_gp_lte_cfg=&
l375_cfg;l997_dc_lte_init();l452_handle_options(l31_argc,l18_argv);
lf_if(_mb000010001("\x31\x32\x37\x2e\x30\x2e\x30\x2e\x31",56000)<0){
lq_return 1;}lf_if(l849_start_lte_ipc_routine()<0){lq_return 1;}
lq_return 0;}lm_uint32_t l1095_dc_lte_id(lb_void){lq_return
l73_IPC_DC_LTE;}lb_void l1112_dc_lte_version(lb_void){}lb_void
l997_dc_lte_init(lb_void){le_struct l158_stat_tbl l158_stat_tbl[]={{0
,{-1,-1},{80,85,90,95},{0},{0},0,-1,-1,-1},{0,{-1,-1},{80,85,90,95},{
0},{0},0,-1,-1,-1},{0,{-1,-1},{45,50,55,60},{0},{0},0,127,127,127},{0
,{-1,-1},{45,50,55,60},{0},{0},0,127,127,127}};l109_memcpy(&
_mb000000001,&l158_stat_tbl,lw_sizeof(_mb000000001));_mb000000002=240
;}lb_void l1100_dc_lte_load_config(li_const lj_char*l230_path){
li_const lj_char*l874_sq_tbl[]={"\x4e\x4f\x4e\x45","\x52\x53\x53\x49"
,"\x52\x53\x52\x50","\x52\x53\x52\x51","\x43\x51\x49"};lj_char
l306_line[256];lj_char l173_temp[256];lj_char l977_threshold_key[32];
lj_char l951_report_interval_key[32];la_int l984_is_indicator_found=0
;la_int l1028_is_threshold_found=0;la_int
l839_is_report_interval_found=0;l71_gp_lte_cfg->l108_idle_threshold=0
;l71_gp_lte_cfg->l235_indicator=4;l71_gp_lte_cfg->l231_threshold_cnt=
3;la_int l1064_default_thresholds[]={5,15,20};l109_memcpy(&
l71_gp_lte_cfg->l422_thresholds,&l1064_default_thresholds,lw_sizeof(
l71_gp_lte_cfg->l422_thresholds));la_int l1107_default_intervals[]={
30,60,120,150};l109_memcpy(&l71_gp_lte_cfg->l241_report_intervals,&
l1107_default_intervals,lw_sizeof(l71_gp_lte_cfg->
l241_report_intervals));l893_FILE*l213_file;l213_file=l1022_fopen(
l230_path,"\x72");lf_if(l213_file==lu_NULL){lq_return;}l62_while(
l1082_fgets(l306_line,lw_sizeof(l306_line),l213_file)!=lu_NULL){
lj_char*lo_value;lj_char*l98_token;la_int ld_i;lo_value=l712_strchr(
l306_line,'=');lf_if(lo_value==lu_NULL){l288_continue;} *lo_value++=0
;l98_token=l1053_strrchr(lo_value,'\n');lf_if(l98_token){ *l98_token=
0;}lf_if(!l984_is_indicator_found){lf_if(!l273_strcmp(l306_line,"\x52"
"\x45\x50\x4f\x52\x54\x5f\x49\x4e\x54\x45\x52\x56\x41\x4c\x5f\x49\x4e"
"\x44\x49\x43\x41\x54\x4f\x52")){l21_for(ld_i=1;ld_i<(lw_sizeof(
l874_sq_tbl)/lw_sizeof(l874_sq_tbl[0]));ld_i++){lf_if(!l273_strcmp(
lo_value,l874_sq_tbl[ld_i])){l984_is_indicator_found=1;l71_gp_lte_cfg
->l235_indicator=ld_i;l219_sprintf(l977_threshold_key,"\x25\x73\x5f"
"\x54\x48\x52\x45\x53\x48\x4f\x4c\x44\x53",lo_value);l219_sprintf(
l951_report_interval_key,"\x25\x73\x5f\x52\x45\x50\x4f\x52\x54\x5f"
"\x49\x4e\x54\x45\x52\x56\x41\x4c\x53",lo_value);ly_break;}}}}l3_else
lf_if(!l1028_is_threshold_found){lf_if(!l273_strcmp(l306_line,
l977_threshold_key)){la_int l231_threshold_cnt=0;l361_strcpy(
l173_temp,lo_value);l98_token=l292_strtok(l173_temp,"\x2c");l62_while
(l98_token){l231_threshold_cnt++;l98_token=l292_strtok(lu_NULL,"\x2c"
);}lf_if(l231_threshold_cnt>=8){ly_break;}l1028_is_threshold_found=1;
l71_gp_lte_cfg->l231_threshold_cnt=l231_threshold_cnt;l98_token=
l292_strtok(lo_value,"\x2c");l21_for(ld_i=0;ld_i<l231_threshold_cnt;
ld_i++){l71_gp_lte_cfg->l422_thresholds[ld_i]=(la_int)l836_strtol(
l98_token,lu_NULL,10);l98_token=l292_strtok(lu_NULL,"\x2c");}}}
l3_else lf_if(!l839_is_report_interval_found){lf_if(!l273_strcmp(
l306_line,l951_report_interval_key)){la_int l851_report_interval_cnt=
0;l361_strcpy(l173_temp,lo_value);l98_token=l292_strtok(l173_temp,""
"\x2c");l62_while(l98_token){l851_report_interval_cnt++;l98_token=
l292_strtok(lu_NULL,"\x2c");}lf_if(l851_report_interval_cnt!=
l71_gp_lte_cfg->l231_threshold_cnt+1){ly_break;}
l839_is_report_interval_found=1;l98_token=l292_strtok(lo_value,"\x2c"
);l21_for(ld_i=0;ld_i<l851_report_interval_cnt;ld_i++){l71_gp_lte_cfg
->l241_report_intervals[ld_i]=(la_int)l836_strtol(l98_token,lu_NULL,
10);lf_if(l71_gp_lte_cfg->l241_report_intervals[ld_i]<30){
l71_gp_lte_cfg->l241_report_intervals[ld_i]=30;}l3_else lf_if(
l71_gp_lte_cfg->l241_report_intervals[ld_i]>240){l71_gp_lte_cfg->
l241_report_intervals[ld_i]=240;}l98_token=l292_strtok(lu_NULL,"\x2c"
);}ly_break;}}}lf_if(!l839_is_report_interval_found){l71_gp_lte_cfg->
l235_indicator=l730_REPORT_INTERVAL_INDICATOR_NONE;}l896_fclose(
l213_file);}
